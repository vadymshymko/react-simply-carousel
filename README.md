...
| **centerMode** (disabled if `infinite` prop disabled) | boolean                          | `false`                       | Boolean indicating if the active slide should be aligned to center of container viewport                                                                                                                                                                              |
| **infinite**                                          | boolean                          | `false`                       | Boolean indicating                                                                                                                                                                                                                                                    |
| **disableNavIfEdgeVisible**                           | boolean                          | `false`                       | Boolean indicating                                                                                                                                                                                                                                                    |
| **disableNavIfEdgeActive**                            | boolean                          | `false`                       | Boolean indicating                                                                                                                                                                                                                                                    |
